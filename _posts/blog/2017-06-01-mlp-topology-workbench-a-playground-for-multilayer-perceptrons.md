...
I took the idea of a playground from [Tensorflow's playground][TFPlayground]{:target="_blank"}, since you are free to play with multilayer perceptrons from this tool. In fact, I encourage you to make your own! It is quite a good way to explore your expertise from different perspectives. Have fun!
